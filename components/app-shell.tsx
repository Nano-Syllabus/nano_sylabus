  ...
  return (
    <AppShellContext.Provider value={shellContextValue}>
      <div className="flex h-[100dvh] overflow-hidden bg-bg-primary text-text-primary">
        <aside
          aria-hidden={sidebarSuppressed}
          inert={sidebarSuppressed}
          className={
            "fixed inset-y-0 left-0 z-30 flex flex-col border-r transition-[width,transform,opacity,border-color] duration-200 ease-in-out motion-reduce:transition-none md:static md:translate-x-0 " +
            (sidebarSuppressed
