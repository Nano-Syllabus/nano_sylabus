...
const NAV = [
  ...
  { href: "/app/courses", label: "My Courses", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg> },
  { href: "/app/explore", label: "Subjects", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H20v15H6.5A2.5 2.5 0 0 0 4 19.5z"/><path d="M8 6h8"/><path d="M8 10h6"/></svg> },
    ...
    <div className="font-sidebar-ui flex h-full w-full flex-col bg-bg-primary text-text-primary">
      ...
      <div className={cn("mt-auto shrink-0 space-y-0.5 border-t border-border pt-2", isCollapsed ? "px-2 pb-1" : "px-3 pb-1")}>
        <Link
          ...
          title={isCollapsed ? "Creator portal" : undefined}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
