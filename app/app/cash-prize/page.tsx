...
function PrizeChip({ medal, children }: { medal: string; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-1 rounded-md bg-white/40 px-2 py-1 text-xs font-semibold text-[#0f172a]">
      ...
      <main className="font-figma-library min-h-full bg-bg-primary px-4 pb-12 pt-8 sm:px-6 lg:px-8 lg:pt-[55px]">
        <div className="mx-auto w-full max-w-[1100px] xl:origin-top xl:scale-90">
          <header className="flex min-h-[124px] flex-col items-start justify-between gap-5 sm:flex-row">
            <div>
              <h1 className="text-[32px] font-bold leading-none tracking-[-0.035em] text-[#0f172a] sm:text-[40px] lg:text-[48px]">
                Earn while you learn
              </h1>
              <p className="mt-3 text-base font-medium text-[#475569] lg:text-lg">
                Complete challenges. Score higher. Win cash.
              </p>
            </div>
            <div className="inline-flex items-center gap-[9px] rounded-full border-[1.5px] border-[#e2e8f0] bg-white px-[18px] py-[9px] text-base font-medium text-[#475569] lg:mt-[10px] lg:text-[19.5px]">
          ...
          <section className="space-y-6" aria-label="Cash prize campaigns">
            <article className="relative overflow-hidden rounded-[24px] border border-[#6dd944] bg-[#e0feb1] p-6 lg:min-h-[330px] lg:p-8 xl:h-[330px]">
              <div className="relative z-10 grid items-center gap-6 lg:grid-cols-[300px_minmax(230px,1fr)] xl:h-[266px] xl:grid-cols-[300px_256px]">
                <div className="flex min-h-[242px] flex-col items-start gap-4">
                  <div className="inline-flex items-center gap-1.5 rounded-full bg-white px-2.5 py-1 text-xs font-bold text-[#475569]">
                    <span className="size-1.5 rounded-full bg-[#22c55e]" aria-hidden="true" />
                    DAILY
                  </div>
                  <div>
                    <h2 className="text-[30px] font-bold leading-[1.45] text-[#0f172a]">
                      Daily Challenge Lottery
                    </h2>
                    <p className="mt-2 max-w-[280px] text-base leading-[1.4] text-[#3d5a1f]">
                      Complete 1 challenges and enter tonight&apos;s draw.
                    </p>
                  </div>
                  <div className="mt-auto w-full max-w-[300px]">
                    <p className="text-[13px] font-medium text-[#3d5a1f]">
                      {dailyProgress.completedForEntry}/{dailyProgress.requiredForEntry} completed
                    </p>
                    <div
                      className="mt-1.5 h-2 overflow-hidden rounded-full bg-white/50"
                      role="progressbar"
            ...
            <article className="relative overflow-hidden rounded-[24px] border border-[#cbcbcb] bg-[#e3e3e5] p-6 lg:min-h-[330px] lg:p-8 xl:h-[330px]">
              <div className="relative z-10 grid items-center gap-6 lg:grid-cols-[300px_minmax(270px,1fr)] xl:h-[266px] xl:grid-cols-[300px_335px]">
                <div className="flex min-h-[242px] flex-col items-start gap-4">
                  ...
                  <div>
                    <h2 className="max-w-[316px] text-[30px] font-bold leading-[1.45] text-[#0f172a]">
                      IOE Top Scorer Award
                    </h2>
                    <p className="mt-2 max-w-[280px] text-[15px] font-medium leading-[1.4] text-[#475569]">
                ...
                <div className="flex flex-col items-start gap-4">
                  <div>
                    <p className="text-sm font-medium text-[#0f172a]">TOTAL PRIZE POOL</p>
                    <p className="text-[32px] font-bold leading-[1.5] text-[#646b76]">Rs. 40,000</p>
                  </div>
                  <div className="grid grid-cols-2 gap-1.5 text-xs font-semibold text-[#0f172a]">
                    {[
                      ["1st Year", "Rs.10,000"],
                      ["2nd Year", "Rs.10,000"],
                      ["3rd Year", "Rs.10,000"],
                      ...
                      <div
                        key={year}
                        className="rounded-md bg-white/40 px-2 py-1 whitespace-nowrap"
                      >
                        {year} <span className="text-[#646b76]">{amount}</span>
                      </div>
                    ))}
                  </div>
                  <div className="space-y-2">
